...
export const Button = component$<ButtonProps>(
  ({
    ...
    const renderButton = () => {
      switch (variant) {
        case 'squareSmallContained':
          return (
            <button
              type="button"
              tabIndex={tabIndex}
              class={[
                'w-full max-w-[220px] text-black  hover:text-white bg-primary hover:bg-secondary hover:opacity-70 p-2 uppercase text-sm font-bold border-0 transition-all duration-[0.4s]',
                className,
              ]}
              onClick$={onClick}
              disabled={disabled}
        ...
        case 'squareSmallOutlined':
          return (
            <button
              type="button"
              tabIndex={tabIndex}
              class={[
                'group w-full max-w-[220px] p-2 uppercase text-white hover:text-white text-sm font-bold border-0 z-[1] relative transition-all duration-[0.4s]',
            ...
            >
              <span
                class={[
                  'bg-hover-gradient absolute inset-1.5 opacity-0 group-hover:opacity-100 z-[-1] transition-all duration-[0.4s]',
                ]}
              ></span>
              {text}
            </button>
        ...
        case 'squareOutlined':
          return (
            <button
              type="button"
              class={[
                'group w-full max-w-[596px] p-3.5 uppercase text-primary hover:text-white text-sm font-bold border-0 z-[1] relative transition-all duration-[0.4s]',
        ...
        case 'circular':
          return (
            <button
              type="button"
              class={[
                'group w-full max-w-[437px] p-4 text-white bg-[#0c0c0c] uppercase text-base font-bold border-0 rounded-full flex justify-center items-center gap-5 shrink-0 overflow-hidden relative z-[1] transition-padding duration-[0.4s] hover:pl-10',
            ...
            >
              ...
              <span class={styles.icon}>
                <IconArrowRight
                  class={`block transition-all duration-[0.4s] ${styles.icon_arraow_right} group-hover:translate-x-2.5`}
                />
              </span>
            </button>
          );
