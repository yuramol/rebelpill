        ...
        {variant === 'outlined' ? (
          <div class={`relative h-[54px] w-full min-w-[200px]`}>
            <input
              type={type}
              class={cn(
                `peer h-full w-full rounded-[7px] border bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-pink-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50`,
            ...
            {label ? (
              <label
                class={cn(
                  ...
                  error
                    ? 'peer-focus:after:border-red-500 peer-focus:before:border-red-500'
                    : ''
                )}
              >
                {label}
            ...
            {error && helperText ? (
              <div class="absolute bottom-[-16px] left-0 text-red-500 text-xs leading-3 ">
                {helperText}
              </div>
            ) : null}
          </div>
          ...
          <div class="relative h-[54px] w-full min-w-[200px]">
            ...
            {label ? (
              <label
                class={cn(
                  `after:content[' '] pointer-events-none absolute left-0 -top-1.5 flex h-full w-full select-none text-[11px] font-normal leading-tight text-blue-gray-500 transition-all after:absolute after:-bottom-1.5 after:block after:w-full after:scale-x-0 after:border-b-2 after:border-primary after:transition-transform after:duration-300 peer-placeholder-shown:text-sm peer-placeholder-shown:leading-[5.5] peer-placeholder-shown:text-blue-gray-500 peer-focus:text-[11px] peer-focus:leading-tight  peer-focus:after:scale-x-100 peer-focus:after:border-pink-500 peer-disabled:text-transparent peer-disabled:peer-placeholder-shown:text-blue-gray-500`,
                  error ? 'peer-focus:after:border-red-500 ' : ''
                )}
              >
                {label}
              </label>
            ...
            {error && helperText ? (
              <div class="text-red-500 text-xs leading-3 absolute bottom-[-16px] left-0">
                {helperText}
              </div>
            ) : null}
          </div>
