          ...
          <ul class="flex flex-row gap-[5px] text-center text-white text-base">
            {headerNav.map(({ id, title, href }) => (
              <li
                key={id}
                class={[
                  'py-[10px] px-5 bg-grey rounded-full group flex whitespace-nowrap justify-center items-center gap-5 shrink-0 overflow-hidden relative z-[1] transition-padding duration-[0.4s]',
