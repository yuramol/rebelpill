...
export const Profit = component$(() => {
  return (
    <div class="flex flex-col w-full max-w-full md:max-w-[557px] h-auto xl:h-[534px] px-5 py-[30px] md:px-8 md:py-11 lg:px-[60px] lg:pt-[93px] lg:pb-[70px] xl:pb-[85px] border border-[rgba(255, 255, 255, 0.50)] rounded-[5px]">
